...
df = pd.read_csv('bitcoin_2012-01-01_to_2018-10-31.csv', encoding='utf-8')
# 将时间作为df的索引
...
result_table.columns = ['parmeters', 'aic']
print('最优模型:', best_model.summary())
# 比特币预测
df_month2 = df_month[['Weighted_Price']]
date_list = [datetime(2018, 11, 30), datetime(2018, 12, 31), datetime(2019, 1, 31), datetime(2019, 2, 28), datetime(2019, 3, 31), datetime(2019, 4, 30),
